...
//       <h2 style={{ color: "#0ea5e9", marginBottom: "40px" }}>
...
//           }}
//         >
//           <h3 style={{ color: "#38bdf8" }}>Flanker Task (→)</h3>
...
//           }}
//         >
//           <h3 style={{ color: "#10b981" }}>AX-CPT (A→X)</h3>
//           <p style={{ color: "#94a3b8", fontSize: "14px" }}>
//             Đo lường sự chú ý duy trì trong thời gian dài và sự bốc đồng.
//           </p>
//         </div>
//       </div>
//     </div>
